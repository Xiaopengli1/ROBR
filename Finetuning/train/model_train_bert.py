...
data = pd.read_csv("data/industrial/all_data.txt",encoding='utf-8',header=None,sep = '\t',error_bad_lines=False)
...
model_save_path = 'model_path/Pre_trained_model/cn/bert-base-chinese'
# model_save_path = 'model_path/Pre_trained_model/cn/chinese-roberta-wwm-ext'
# model_save_path = 'model_path/Pre_trained_model/cn/ernie-3.0-base-zh'
...
# model_path = CrossEncoder("model_path/Raw_model/cn/chinese-roberta-wwm-ext",num_labels=5, device="cuda", max_length=512)
# model_path = CrossEncoder("model_path/Raw_model/cn/ernie-3.0-base-zh",num_labels=5, device="cuda", max_length=512)
